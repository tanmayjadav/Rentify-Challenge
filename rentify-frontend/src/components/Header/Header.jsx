...
const Header = () => {
  ...
  return (
    <>
      <header className="bg-background top-0 fixed z-50 shadow-[0_17px_17px_-25px_rgba(0,0,0,0.3)] dark:shadow-[0_17px_17px_-25px_rgba(255,255,255,0.4)] w-screen text-white pl-3 md:pl-8 pr-3 md:pr-8 flex justify-between items-center">
